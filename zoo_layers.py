...
def block_resnet(inputs, layer_params, training, name):
    ...
    with tf.variable_scope(name):
        ...
        if shape_in[3] != shape_out[3]:
            #
            item = [shape_out[3], 1, (1,1), 'same', False, False, 'shortcut_conv']
            #
...
def incept_block(inputs, K, depth_arr, training, name):
    ...
    with tf.variable_scope(name):
        #
        params_1 = [depth_arr[0], [1, K], (1,1), 'same', False, False, 'branch1']
        params_2 = [depth_arr[1], [K, 1], (1,1), 'same', False, False, 'branch2']
        params_3_1 = [depth_arr[2], [1, K], (1,1), 'same', False, False, 'branch3_1']
        params_3_2 = [depth_arr[3], [K, 1], (1,1), 'same', False, False, 'branch3_2']
        params_4 = [depth_arr[4], [K, K], (1,1), 'same', False, False, 'branch4']
        #
